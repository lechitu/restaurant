  ...
  <div class="action-cafe-edited action-cafe-detail">
    <div class="grid-x grid-padding-x">
        ...
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
            ...
            <span
              ...
              v-bind:class="{'change': content.after.company_name != action.company.name }"
            >{{ content.after.company_name }}</span>
          </div>
        </div>
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
            ...
            <span
              class="action-content"
              v-bind:class="{'change': content.after.website != action.company.website }"
            >{{ content.after.website }}</span>
          </div>
        </div>
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
            ...
            <span
              class="action-content"
              v-bind:class="{'change': content.after.location_name != action.cafe.location_name }"
            >{{ content.after.location_name }}</span>
          </div>
        </div>
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
            ...
            <span
              class="action-content"
              v-bind:class="{'change': content.after.address != action.cafe.address }"
            >{{ content.after.address }}</span>
          </div>
        </div>
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
            ...
            <span
              class="action-content"
              v-bind:class="{'change': content.after.city != action.cafe.city }"
            >{{ content.after.city }}</span>
          </div>
        </div>
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
            ...
            <span
              class="action-content"
              v-bind:class="{'change': content.after.zip != action.cafe.zip }"
            >{{ content.after.zip }}</span>
          </div>
        </div>
        <div class="grid-x">
          <div class="large-12 medium-12 small-12 cell">
      ...
      <div class="large-12 medium-12 cell">
        ...
        >Cafe Updated by {{ action.by.name }} on {{ action.created_at }}</span>
      </div>
    </div>
  </div>
</template>
      ...
      for (let i = 0; i < contentBrewMethods.length; i++) {
        for (let k = 0; k < this.brewMethods.length; k++) {
          /*
            ...
            */
          if (
            parseInt(contentBrewMethods[i]) == parseInt(this.brewMethods[k].id)
          ) {
