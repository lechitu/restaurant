...
<template>
  <transition name="slide-in-left">
    <div
      ...
      v-show="showFilters && cafesView == 'map'"
    >
      ...
      <div class="grid-x grid-padding-x">
        <div class="large-12 medium-12 small-12 cell">
          <span class="filters-header">Find the type of coffee shop you are looking forPLA!</span>
        </div>
      </div>
      ...
      <div id="location-type-container">
        ...
        <div class="grid-x grid-padding-x">
          <div class="large-12 medium-12 small-12 cell">
            <div
              class="location-filter all-locations"
              v-bind:class="{ 'active': activeLocationFilter == 'all' }"
              v-on:click="setActiveLocationFilter('all')"
            >All Locations</div>
            <div
              class="location-filter restaurant"
              v-bind:class="{ 'active': activeLocationFilter == 'restaurant' }"
              v-on:click="setActiveLocationFilter('restaurant')"
            >Restaurant</div>
            <div
              class="location-filter cafes"
      ...
      <div
        ...
        id="only-liked-container"
        v-show="user != '' && userLoadStatus == 2"
      >
        <div class="large-12 medium-12 small-12 cell">
          <input type="checkbox" v-model="onlyLiked">
          <span class="liked-location-label">Show only locations that I like</span>
        </div>
      </div>

      <!-- <div
        class="grid-x grid-padding-x"
        v-show="activeLocationFilter == 'restaurant' || activeLocationFilter == 'all'"
      >
        <div class="large-12 medium-12 small-12 cell">
      ...
      >
        <div class="large-12 medium-12 small-12 cell">
          <div
            ...
            v-on:click="toggleSubscriptionFilter()"
        ...
        <div class="grid-x grid-padding-x">
          <div class="large-8 medium-9 small-12 cell centered">
            <div
              ...
              v-on:click="toggleBrewMethodFilter( method.id )"
