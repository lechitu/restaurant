    ...
    <div class="grid-x">
      <div class="large-4 medium-4 small-4 cell">
        <a class="filters" v-bind:class="{'active': showFilters}" v-on:click="toggleShowFilters()">
          <img
            class="chevron"
            v-bind:class="{'list' : cafesView == 'list'}"
            src="/img/chevron-right.svg"
          >
          <img
            class="chevron-active"
            v-bind:class="{'list' : cafesView == 'list'}"
            src="/img/chevron-right-active.svg"
          > Filters
          <span
            class="filter-count-active"
      ...
      <div class="large-4 medium-4 small-4 cell">
        <router-link :to="{ name: 'cafes'}">
          <h2
            class="text-center"
            style="font-size: 40px; text-transform: uppercase;font-weight: 900;color: #8e8787;"
          >Restaurant</h2>
        </router-link>
      </div>
      <div class="large-4 medium-4 small-4 cell">
