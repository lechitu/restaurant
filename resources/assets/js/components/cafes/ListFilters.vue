...
<template>
  <transition name="slide-in-top">
    <div
      class="large-12 medium-12 small-12 cell list-filters-container"
          ...
          <div class="grid-x grid-padding-x">
            ...
            <div class="large-6 medium-6 small-12 cell">
              ...
              <span
                ...
                v-on:click="setOrderDirection('asc')"
              >Asc</span>
              <span
                class="desc order-direction"
                v-bind:class="{ 'active': orderDirection == 'desc' }"
                v-on:click="setOrderDirection('desc')"
              >Desc</span>
            </div>
          </div>
