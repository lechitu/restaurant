    ...
    processFilters() {
      for (var i = 0; i < this.$markers.length; i++) {
        if (
          ...
          /*
                  Check if the restaurant passes
                */
          if (
            this.processCafeTypeFilter(
              this.$markers[i].cafe,
          ...
          if (
            this.textSearch != "" &&
            this.processCafeTextFilter(this.$markers[i].cafe, this.textSearch)
          ) {
            textPassed = true;
          ...
          if (
            this.brewMethodsFilter.length != 0 &&
            this.processCafeBrewMethodsFilter(
              this.$markers[i].cafe,
          ...
          if (
            this.onlyLiked &&
            this.processCafeUserLikeFilter(this.$markers[i].cafe)
          ) {
            likedPassed = true;
          ...
          if (
            this.hasSubscription &&
            this.processCafeSubscriptionFilter(this.$markers[i].cafe)
          ) {
          ...
          if (
            this.cityFilter != "" &&
            this.processCafeInCityFilter(this.$markers[i].cafe, this.cityFilter)
          ) {
            cityPassed = true;
    ...
    buildMarkers() {
      ...
      for (var i = 0; i < this.cafes.length; i++) {
        /*
          ...
          */
        if (this.cafes[i].company.restaurant == 1) {
          var image = "/img/restaurant-marker.svg";
        } else {
