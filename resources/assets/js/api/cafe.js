...
export default {
	...
	*/
	...
	/*
		POST 	/api/v1/cafes
	*/
	postAddNewCafe: function (companyName, companyID, companyType, subscription, website, instagramURL, facebookURL, twitterURL, locationName, address, city, zip, lat, lng, brewMethods) {
		/*
	...
	*/
	putEditCafe: function (slug, companyName, companyID, companyType, subscription, website, instagramURL, facebookURL, twitterURL, locationName, address, city, zip, lat, lng, brewMethods) {
		/*
			Initialize the form data
		*/
		let formData = new FormData();
