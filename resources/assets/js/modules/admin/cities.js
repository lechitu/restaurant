  ...
  actions: {
    ...
    */
    addAdminCity({ commit, state, dispatch }, data) {
      ...
      */
      CitiesAPI.postAddCity(data.name, data.country, data.latitude, data.longitude, data.radius)
        .then(function (response) {
    ...
    */
    updateAdminCity({ commit, state, dispatch }, data) {
      ...
      */
      CitiesAPI.putUpdateCity(data.id, data.name, data.country, data.latitude, data.longitude, data.radius)
        .then(function (response) {
