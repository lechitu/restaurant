    ...
    */
		...
		*/
		editCafe({ commit, state, dispatch }, data) {
			...
			CafeAPI.putEditCafe(data.slug, data.company_name, data.company_id, data.company_type, data.subscription, data.website, data.instagram_url, data.facebook_url, data.twitter_url, data.location_name, data.address, data.city, data.state, data.zip, data.lat, data.lng, data.brew_methods)
				.then(function (response) {
					/*
		...
		*/
		addCafe({ commit, state, dispatch }, data) {
			...
			CafeAPI.postAddNewCafe(data.company_name, data.company_id, data.company_type, data.subscription, data.website, data.instagram_url, data.facebook_url, data.twitter_url, data.location_name, data.address, data.city, data.zip, data.lat, data.lng, data.brew_methods)
				.then(function (response) {
