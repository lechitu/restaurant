  ...
  <div id="admin-cities">
    ...
    <div class="grid-container">
      <div class="grid-x list-header">
        <div class="large-3 medium-3 cell">Name</div>

        <div class="large-3 medium-3 cell">Country</div>
        <div class="large-3 medium-3 cell"></div>
      </div>
      <div class="grid-x listing" v-for="city in cities">
        <div class="large-3 medium-3 cell">{{ city.name }}</div>
        <div class="large-3 medium-3 cell">{{ city.country }}</div>
